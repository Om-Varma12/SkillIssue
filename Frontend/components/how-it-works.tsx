        ...
        <div className="grid md:grid-cols-3 gap-8 items-stretch">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className="relative group animate-slide-up flex"
              ...
              >
                ...
                <div className="relative p-8 border border-border rounded-2xl hover:border-primary transition-all duration-300 w-full flex flex-col">
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden md:flex absolute -right-4 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-primary rounded-full items-center justify-center text-white font-bold text-center z-10">
                      →
                    </div>
                  )}
                </div>
